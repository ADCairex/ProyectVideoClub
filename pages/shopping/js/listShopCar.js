...
function createDivProductCar(product, divContainer) {
    if (product.routProduct.includes('.mp3')) {
        ...
        div += '</div>';
        div += '<div>';
        div += '<h4></i>Cantidad: ' + product.quantity + '</h4><i class="fa-solid fa-cart-shopping">'; //Number visualizacions bought
        div += '</div>';
        div += '<div>';
        ...
        div += '</div>';
        div += '<div>';
        div += '<h4>Cantidad: ' + product.quantity + '</h4><i class="fa-solid fa-cart-shopping"></i>'; //Number visualizacions bought
        div += '</div>';
        div += '<div>';
        div += '<h4>Precio total: ' + product.linePrice + '</h4>'; //Number visualizacions bought
        div += '</div>';
